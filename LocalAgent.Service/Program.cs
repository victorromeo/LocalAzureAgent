...
var triggerLoader = new TriggerConfigurationLoader();
var triggers = triggerLoader.Load(builder.Configuration, builder.Environment.ContentRootPath, pipelines).ToList();
