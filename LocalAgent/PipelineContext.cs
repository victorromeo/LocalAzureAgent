...
namespace LocalAgent
{
    public class PipelineContext
    {
        ...
        public void RecordWarning() => Warnings++;
        ...
        public string MaskPipelineForLogging(string pipelineYaml)
        {
            ...
            var masked = MaskSecrets(pipelineYaml);

            // Redact inline secret values in task.setvariable commands before writing the pipeline dump.
