...
namespace LocalAgent
{
    public class PipelineOptions
    {
        ...
        public const string AgentWorkFolderDefault = "${Agent.UserProfileDirectory}/work";
        ...
        public const bool DryRunDefault = false;
        public const string DryRunHelpText = "If true, parse and evaluate the pipeline without executing external tools or task runners";
        ...
        /// If not provided, the directory of the YAML file is used.
        /// </summary>
        [Option("source", HelpText = "Source Path: (Optional) The absolute or relative path to the source folder. If omitted, uses the directory of the YAML file.")]
        public string SourcePath { get; set; }

        [Option("inplace", Default = BuildInplaceDefault, HelpText = BuildInplaceHelpText)]
        public bool BuildInplace { get; set; }

        [Option("dry-run", Default = DryRunDefault, HelpText = DryRunHelpText)]
        public bool DryRun { get; set; }

        /// <summary>
        /// The path to the yaml pipeline file, which acts as the entry point for the pipeline build process
        /// </summary>
        [Value(0, MetaName = "yml",
            HelpText = "YAML Path: The path to the yaml pipeline file, which acts as the entry point for the pipeline build process", 
            Required = true)]
