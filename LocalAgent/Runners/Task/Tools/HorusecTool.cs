...
{
    public class HorusecTool : CommandToolBase
    {
        public HorusecTool() : base()
        {
            // Optionally set up tool-specific properties or configuration here
        }

        // Optionally override methods if Horusec needs custom behavior

        // Always install horusec in the workspace .tools directory
